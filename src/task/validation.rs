...
mod tests {
    ...
    fn panics_on_compound_and_primitive() {
        App::new()
            ...
            .add_systems(Startup, |mut commands: Commands| {
                commands.spawn((Select, Operator::new(|_: In<Entity>| TaskStatus::Success)));
            })
            .update();
    }
    ...
    fn panics_on_compound_and_compound() {
        ...
        app.add_plugins((MinimalPlugins, BaePlugin::default()))
            .add_systems(Startup, |mut commands: Commands| {
                commands.spawn((Select, Sequence));
            });
        app.finish();
        app.update();
        app.update();
    ...
    fn does_not_panic_on_primitive() {
        App::new()
            .add_plugins((MinimalPlugins, BaePlugin::default()))
            .add_systems(Startup, |mut commands: Commands| {
                commands.spawn(Operator::new(|_: In<Entity>| TaskStatus::Success));
            })
            .update();
    }
